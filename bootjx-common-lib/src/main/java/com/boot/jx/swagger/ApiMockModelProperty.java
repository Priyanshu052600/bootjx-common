...
public @interface ApiMockModelProperty {
	/**
	...
	/**
	 * Allows for filtering a property from the API documentation. See
	 * io.swagger.core.filter.SwaggerSpecFilter.
	 */
	 ...
	 * type as read from the class property.
	 */
	...
	/**
	 * Specifies a reference to the corresponding type definition, overrides any
	 * other metadata specified
	 */
